...
public class UnusedFluids {
	...
	public static final FlowingFluid MUD_FLUID_STILL = register("mud_fluid", new MudFluid.Source());
    public static final FlowingFluid MUD_FLUID_FLOWING = register("mud_fluid_flowing", new MudFluid.Flowing());
