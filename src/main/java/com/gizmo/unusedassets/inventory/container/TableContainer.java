...
public class TableContainer extends Container {
	...
	private static TableTileEntity getTile(final PlayerInventory inventory, final PacketBuffer data) {
		...
		throw new IllegalStateException("Well, you really fucked up this time. This error is coming from the TableContainer class if you want to troubleshoot it, but I doubt you will, dumbass.");
	}
