...
public class LobberZombieModel<T extends LobberZombieEntity> extends SegmentedModel<T> {
	...
	public LobberZombieModel() {
		...
		rightArm.setTextureOffset(18, 32).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 11.0F, 4.0F, 0.0F, false);

		leftArm = new ModelRenderer(this);
		leftArm.setRotationPoint(5.0F, 2.0F, 0.0F);
		main.addChild(leftArm);
		leftArm.setTextureOffset(34, 32).addBox(-1.0F, -2.0F, -2.0F, 5.0F, 14.0F, 4.0F, 0.0F, false);
