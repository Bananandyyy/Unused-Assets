...
public class MidnightChickenModel extends AgeableModel<MidnightChickenEntity> {
	...
	public void setRotationAngles(MidnightChickenEntity entity, float limbSwing, float limbSwingAmount,
