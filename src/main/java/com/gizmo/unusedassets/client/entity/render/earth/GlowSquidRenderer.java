...
import com.gizmo.unusedassets.client.entity.render.earth.layers.GlowingSquidGlowLayer;
...
public class GlowSquidRenderer extends MobRenderer<GlowSquidEntity, SquidModel<GlowSquidEntity>> {
    ...
    public ResourceLocation getEntityTexture(GlowSquidEntity entity) {
        ResourceLocation textureFrame = new ResourceLocation("unusedassets:textures/entity/earth/squid/glow_squid/glow_squid_anim_1.png");
        return textureFrame;
    }
