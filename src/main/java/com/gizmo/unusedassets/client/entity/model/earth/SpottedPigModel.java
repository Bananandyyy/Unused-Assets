...
public class SpottedPigModel extends AgeableModel<SpottedPigEntity> {
	...
	public void setRotationAngles(SpottedPigEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks,
