...
public class SunsetCowModel extends AgeableModel<SunsetCowEntity> {
	...
	public void setRotationAngles(SunsetCowEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
