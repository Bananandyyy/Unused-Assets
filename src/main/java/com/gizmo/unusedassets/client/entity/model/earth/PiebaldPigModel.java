...
public class PiebaldPigModel extends AgeableModel<PiebaldPigEntity> {
	...
	public void setRotationAngles(PiebaldPigEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks,
