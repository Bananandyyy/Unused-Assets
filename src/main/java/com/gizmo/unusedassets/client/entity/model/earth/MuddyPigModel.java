...
public class MuddyPigModel extends AgeableModel<MuddyPigEntity> {
	...
	public void setRotationAngles(MuddyPigEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks,
