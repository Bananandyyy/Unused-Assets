...
@OnlyIn(Dist.CLIENT)
public class MoolipLayer<T extends MoolipEntity> extends LayerRenderer<T, CowModel<T>> {

	public MoolipLayer(IEntityRenderer<T, CowModel<T>> rendererIn) {
		super(rendererIn);
	}
	...
	public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn,
		...
		if (!entitylivingbaseIn.isChild() && !entitylivingbaseIn.isInvisible()) {
			...
			BlockState blockstate = EarthBlocks.PINK_DAISY.getDefaultState();
