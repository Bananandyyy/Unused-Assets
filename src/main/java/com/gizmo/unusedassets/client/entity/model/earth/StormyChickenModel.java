...
public class StormyChickenModel extends AgeableModel<StormyChickenEntity> {
	...
	public void setRotationAngles(StormyChickenEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks,
