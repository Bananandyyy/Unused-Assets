...
import com.gizmo.unusedassets.events.ModGuiContainerEvent;
...
public abstract class ModScreen<T extends Container> extends Screen implements IHasContainer<T> {
	...
	private void drawItemStack(ItemStack stack, int x, int y, String altText) {
		...
		this.field_230707_j_.renderItemOverlayIntoGUI(font, stack, x, y - (this.draggedStack.isEmpty() ? 0 : 8),
				altText);
	...
	private void func_238746_a_(MatrixStack p_238746_1_, Slot p_238746_2_) {
		...
		String s = null;
		if (p_238746_2_ == this.clickedSlot && !this.draggedStack.isEmpty() && this.isRightMouseClick
				&& !itemstack.isEmpty()) {
			itemstack = itemstack.copy();
			...
			if (Container.canAddItemToSlot(p_238746_2_, itemstack1, true)
					&& this.container.canDragIntoSlot(p_238746_2_)) {
				itemstack = itemstack1.copy();
				flag = true;
				Container.computeStackSize(this.dragSplittingSlots, this.dragSplittingLimit, itemstack,
						p_238746_2_.getStack().isEmpty() ? 0 : p_238746_2_.getStack().getCount());
	...
	public boolean func_231044_a_(double p_231044_1_, double p_231044_3_, int p_231044_5_) {
		if (super.func_231044_a_(p_231044_1_, p_231044_3_, p_231044_5_)) {
			...
			if (p_231044_5_ != 0 && p_231044_5_ != 1 && !flag) {
				...
				if (this.field_230706_i_.gameSettings.touchscreen && flag1
						&& this.field_230706_i_.player.inventory.getItemStack().isEmpty()) {
						...
						if (this.field_230706_i_.player.inventory.getItemStack().isEmpty()) {
							if (this.field_230706_i_.gameSettings.keyBindPickBlock.isActiveAndMatches(mouseKey)) {
								...
								boolean flag2 = l != -999 && (InputMappings
										.isKeyDown(Minecraft.getInstance().getMainWindow().getHandle(), 340)
							...
							} else if (this.field_230706_i_.gameSettings.keyBindPickBlock
	...
	protected boolean hasClickedOutside(double mouseX, double mouseY, int guiLeftIn, int guiTopIn, int mouseButton) {
		return mouseX < (double) guiLeftIn || mouseY < (double) guiTopIn || mouseX >= (double) (guiLeftIn + this.xSize)
				|| mouseY >= (double) (guiTopIn + this.ySize);
	}

	public boolean func_231045_a_(double p_231045_1_, double p_231045_3_, int p_231045_5_, double p_231045_6_,
			double p_231045_8_) {
	...
	public boolean func_231048_c_(double p_231048_1_, double p_231048_3_, int p_231048_5_) {
		...
		if (this.doubleClick && slot != null && p_231048_5_ == 0
				&& this.container.canMergeSlot(ItemStack.EMPTY, slot)) {
			if (func_231173_s_()) {
				if (!this.shiftClickedSlot.isEmpty()) {
					for (Slot slot2 : this.container.inventorySlots) {
						if (slot2 != null && slot2.canTakeStack(this.field_230706_i_.player) && slot2.getHasStack()
			...
			if (this.clickedSlot != null && this.field_230706_i_.gameSettings.touchscreen) {
				if (p_231048_5_ == 0 || p_231048_5_ == 1) {
					...
					if (k != -1 && !this.draggedStack.isEmpty() && flag2) {
						this.handleMouseClick(this.clickedSlot, this.clickedSlot.slotNumber, p_231048_5_,
								ClickType.PICKUP);
				...
				if (this.field_230706_i_.gameSettings.keyBindPickBlock.isActiveAndMatches(mouseKey)) {
					...
					boolean flag1 = k != -999 && (InputMappings
							.isKeyDown(Minecraft.getInstance().getMainWindow().getHandle(), 340)
	...
	protected void handleMouseClick(Slot slotIn, int slotId, int mouseButton, ClickType type) {
		...
		this.field_230706_i_.playerController.windowClick(this.container.windowId, slotId, mouseButton, type,
				this.field_230706_i_.player);
	}
	...
	public boolean func_231046_a_(int p_231046_1_, int p_231046_2_, int p_231046_3_) {
		...
		if (super.func_231046_a_(p_231046_1_, p_231046_2_, p_231046_3_)) {
			return true;
				...
				&& !this.field_230706_i_.gameSettings.keyBindInventory.isActiveAndMatches(mouseKey)) {
	...
	protected boolean func_195363_d(int keyCode, int scanCode) {
		if (this.field_230706_i_.player.inventory.getItemStack().isEmpty() && this.hoveredSlot != null) {
			if (this.field_230706_i_.gameSettings.keyBindSwapHands
			...
			for (int i = 0; i < 9; ++i) {
				if (this.field_230706_i_.gameSettings.keyBindsHotbar[i]
						.isActiveAndMatches(InputMappings.getInputByCode(keyCode, scanCode))) {
					this.handleMouseClick(this.hoveredSlot, this.hoveredSlot.slotNumber, i, ClickType.SWAP);
					return true;
				}
