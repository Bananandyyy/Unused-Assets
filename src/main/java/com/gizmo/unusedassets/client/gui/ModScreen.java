...
public abstract class ModScreen<T extends Container> extends Screen implements IHasContainer<T> {
	...
	public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
	      ...
	      net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new ModGuiContainerEvent.DrawBackground(this, matrixStack, mouseX, mouseY));
	      ...
	      net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new ModGuiContainerEvent.DrawForeground(this, matrixStack, mouseX, mouseY));
...
//	      this.font.func_243248_b(matrixStack, this.playerInventory.getDisplayName(), (float)this.playerInventoryTitleX, (float)this.playerInventoryTitleY, 4210752);
	   ...
	   public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
	      ...
	      if (super.keyPressed(keyCode, scanCode, modifiers)) {
	         ...
	         boolean handled = this.itemStackMoved(keyCode, scanCode);
