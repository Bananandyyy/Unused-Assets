...
//		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.NAMELESS_ONE, NamelessRenderer::new);
		...
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.BOLD_STRIPED_RABBIT, renderManagerIn -> new RabbitRenderBase(renderManagerIn, "bold_striped_rabbit"));
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.BONE_SPIDER, BoneSpiderRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.BRONZED_CHICKEN, renderManagerIn -> new ChickenRenderBase(renderManagerIn, "bronzed_chicken"));
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.BRULE_COW, renderManagerIn -> new CowRenderBase(renderManagerIn, "brule_cow"));
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.CLUCK_SHROOM, CluckShroomRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.COOKIE_COW, renderManagerIn -> new CowRenderBase(renderManagerIn, "cookie_cow"));
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.DAIRY_COW, renderManagerIn -> new CowRenderBase(renderManagerIn, "dairy_cow"));
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.DYED_CAT, renderManagerIn -> new CatRenderBase(renderManagerIn, "dyed_cat"));
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.FANCY_CHICKEN, FancyChickenRenderer::new);
		...
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.GOLD_CRESTED_CHICKEN, renderManagerIn -> new ChickenRenderBase(renderManagerIn, "gold_crested_chicken"));
		...
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.MOOLIP, MoolipRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.MOTTLED_PIG, renderManagerIn -> new PigRenderBase(renderManagerIn, "mottled_pig"));
		...
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.PATCHED_SHEEP, PatchedSheepRenderer::new);
		...
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.PINTO_COW, renderManagerIn -> new CowRenderBase(renderManagerIn, "pinto_cow"));
		...
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.SKEWBALD_CHICKEN, renderManagerIn -> new ChickenRenderBase(renderManagerIn, "skewbald_chicken"));
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.SOOTY_PIG, renderManagerIn -> new PigRenderBase(renderManagerIn, "sooty_pig"));
		...
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.VILER_WITCH, renderManagerIn -> new WitchRenderBase(renderManagerIn, "viler_witch"));
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.WOOLY_COW, WoolyCowRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.BOULDERING_ZOMBIE, BoulderingZombieRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(UnusedEntities.LOBBER_ZOMBIE, LobberZombieRenderer::new);
        ...
        RenderTypeLookup.setRenderLayer(EarthBlocks.PINK_DAISY, RenderType.getCutout());
