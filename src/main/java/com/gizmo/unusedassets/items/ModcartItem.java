...
public class ModcartItem extends Item {
	private static final IDispenseItemBehavior MINECART_DISPENSER_BEHAVIOR = new DefaultDispenseItemBehavior() {
	      ...
	      public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
	         ...
	         AbstractModcartEntity abstractminecartentity = AbstractModcartEntity.create(world, d0, d1 + d3, d2, ((ModcartItem)stack.getItem()).minecartType);
	   ...
	   private final AbstractModcartEntity.Type minecartType;

	   public ModcartItem(AbstractModcartEntity.Type minecartTypeIn, Item.Properties builder) {
	      super(builder);
	   ...
	   public ActionResultType onItemUse(ItemUseContext context) {
	      ...
	      if (!blockstate.isIn(BlockTags.RAILS)) {
	         ...
	         if (!world.isRemote) {
	            ...
	            AbstractModcartEntity abstractminecartentity = AbstractModcartEntity.create(world, (double)blockpos.getX() + 0.5D, (double)blockpos.getY() + 0.0625D + d0, (double)blockpos.getZ() + 0.5D, this.minecartType);
