...
public class BronzedChickenEntity extends ChickenBase<BronzedChickenEntity> {

	public BronzedChickenEntity(EntityType<? extends ChickenBase<BronzedChickenEntity>> type, World worldIn) {
		super(type, worldIn);
	}
