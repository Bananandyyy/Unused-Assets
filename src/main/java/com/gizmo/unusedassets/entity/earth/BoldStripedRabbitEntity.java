...
public class BoldStripedRabbitEntity extends RabbitBase<BoldStripedRabbitEntity> {

	public BoldStripedRabbitEntity(EntityType<BoldStripedRabbitEntity> type, World worldIn) {
		super(type, worldIn);
	}
