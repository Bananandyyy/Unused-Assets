...
public class PalePigEntity extends PigBase<PalePigEntity> {

	public PalePigEntity(EntityType<PalePigEntity> p_i50250_1_, World p_i50250_2_) {
	...
	public PigEntity createChild(ServerWorld worldIn, AgeableEntity entity) {
		return UnusedEntities.PALE_PIG.create(worldIn);
	}
