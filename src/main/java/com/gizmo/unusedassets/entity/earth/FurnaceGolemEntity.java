...
import com.gizmo.unusedassets.entity.ai.goal.FurnaceGolemDefendVillageTargetGoal;
import com.gizmo.unusedassets.entity.ai.goal.FurnaceGolemNearestAttackableTargetGoal;
import com.gizmo.unusedassets.entity.ai.goal.FurnaceGolemShowVillagerTorchGoal;

public class FurnaceGolemEntity extends IronGolemEntity {
	public static final DataParameter<Boolean> IS_ANGRY = EntityDataManager.createKey(FurnaceGolemEntity.class,
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new FurnaceGolemNearestAttackableTargetGoal(this, MobEntity.class, 5, false, false,
						(p_213619_0_) -> p_213619_0_ instanceof IMob && !(p_213619_0_ instanceof CreeperEntity)
								&& !(p_213619_0_ instanceof TropicalSlimeEntity)));
	}
