...
public class FleckedSheepEntity extends SingleColoredSheepEntity<FleckedSheepEntity> {

	public FleckedSheepEntity(EntityType<FleckedSheepEntity> type, World worldIn) {
		super(type, worldIn, new ItemStack(Blocks.BROWN_WOOL));
	}
