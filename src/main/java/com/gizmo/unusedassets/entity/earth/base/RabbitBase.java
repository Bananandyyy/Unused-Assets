...
public class RabbitBase<T extends RabbitEntity> extends RabbitEntity {
	...
	public RabbitBase(EntityType<T> type, World worldIn) {
		super(type, worldIn);
		experienceValue = 3;
		setNoAI(false);
	}
	...
	public RabbitEntity createChild(ServerWorld worldIn, AgeableEntity entity) {
		return null;
	}
