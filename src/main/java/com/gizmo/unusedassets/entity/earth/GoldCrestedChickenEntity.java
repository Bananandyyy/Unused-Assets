...
public class GoldCrestedChickenEntity extends ChickenBase<GoldCrestedChickenEntity>{

	public GoldCrestedChickenEntity(EntityType<? extends ChickenBase<GoldCrestedChickenEntity>> type, World worldIn) {
		super(type, worldIn);
	}
