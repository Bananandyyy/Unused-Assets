...
public abstract class ContainerModcartEntity extends AbstractModcartEntity implements IInventory, INamedContainerProvider{
	 ...
	 private NonNullList<ItemStack> minecartContainerItems = NonNullList.withSize(36, ItemStack.EMPTY);
	   ...
	   protected ContainerModcartEntity(EntityType<?> p_i48536_1_, World world) {
	      super(p_i48536_1_, world);
	   }

	   protected ContainerModcartEntity(EntityType<?> p_i48537_1_, double x, double y, double z, World world) {
	      super(p_i48537_1_, world);
	   }
