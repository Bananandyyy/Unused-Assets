...
public class ReducerBlock extends ContainerBlock {
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player,
		...
		if (!worldIn.isRemote) {
			...
			if (tile instanceof ReducerTileEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) player, (ReducerTileEntity) tile, pos);
